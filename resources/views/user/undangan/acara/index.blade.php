    ...
    <div class="container">
      <div class="w-full px-4">
        <div class="max-w-xl mx-auto text-center mb-10">
          ...
          <a href="{{ route('tambah_acara', $datas->id) }}" class="bg-rose-500 py-3 px-3.5 rounded-xl text-white font-semibold tracking-wide hover:bg-red-400 hover:border hover:border-solid hover:border-rose-700 transition duration-300 ease-in-out">
            Tambah
          </a>
        </div>
