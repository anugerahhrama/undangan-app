    ...
    <div class="conteiner">
        <div class="w-full px-4 text-center">
            ...
            <a href="{{ route('tambah_undangan') }}">
                <button type="button" class="text-white bg-rose-500 hover:bg-rose-300 focus:ring-4 focus:ring-rose-500 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-rose-500 dark:hover:bg-rose-300 focus:outline-none dark:focus:ring-rose-500">
                    Tambah Undangan
                </button>
            </a>   
        </div>
